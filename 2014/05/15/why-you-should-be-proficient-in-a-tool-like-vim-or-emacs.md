...
In my last post, I pointed out <a title="Why you should use an IDE instead of vim or emacs" href="http://codecraft.co/2014/05/13/why-you-should-use-an-ide-instead-of-vim-or-emacs/">two little-discussed reasons why I think most engineers should spend most of their time in an IDE</a>.
