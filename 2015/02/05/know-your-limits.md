...
<ol>
	...
	<li>To make matters worse, when a socket failed to bind for this reason, some very low-level code (possibly in the kernel's underlying TCP/IP stack) issued a retry... over and over again. I was seeing logs flood with over 200k retry attempts per second in this unusual state. I had to fix this by <a title="Why Your Software Should Cry" href="../../../2013/05/06/why-your-software-should-cry/">sensing the pain of a retry storm</a> and tripping a <a title="Don’t forget the circuit breakers" href="../../../2013/01/11/dont-forget-the-circuit-breakers/">circuit breaker</a> to keep the logs moderately quiet.</li>
</ol>
...
Anyway, I'm a sadder but wiser programmer now. :-) I need to add <a title="Introducing Marks" href="../../../2014/07/24/introducing-marks/">marks</a> such as <code>+reasonable upper bound</code> and <code>+potential gotcha</code> to the <a title="On bread recipes, maps, and intentions" href="../../../2013/10/24/on-bread-recipes-maps-and-intentions/"><code>intent</code> programming language I'm creating</a>, so that this type of issue is easy to formally communicate. But even without fancy new languages, the programming ecosystems that we all work in today would benefit from more attention to understanding, handling, and communicating limits.
